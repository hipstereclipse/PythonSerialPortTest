"""
Implements protocol logic for PCG550 Pirani/Capacitive combination gauge.
"""
import struct
...
class PCG550Protocol(GaugeProtocol):
    """
    Handles commands and responses for PCG550 combination gauge.
    Implements binary protocol for PCG series gauges.
    """

    def __init__(self, address: int = 254, logger: Optional[object] = None):
        super().__init__(address, logger)
        self.device_id = 0x02  # PCG550 device ID
